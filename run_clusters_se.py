...
if __name__ == "__main__":
    ...
    for embedding in embeddings:
        ...
        print("\n",chosen_embedding)
        embedding_folder_path = f"embedding_results_se/{chosen_embedding}/"

        for dataset_diff in ["easy", "medium", "hard"]:
            print(f"loading embedding for {dataset_diff}...")
            data_path = embedding_folder_path + dataset_diff + ".pkl"
            ...
            for cluster_algo in cluster_algos:
                ...
                save_path = f"cluster_results_se/{chosen_embedding}/{cluster_algo.__name__}/{dataset_diff}.pkl"
